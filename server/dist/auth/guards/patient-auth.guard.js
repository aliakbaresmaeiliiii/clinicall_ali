...
exports.PatientAuthGuard = void 0;
const common_1 = require("@nestjs/common");
const passport_1 = require("@nestjs/passport");
const core_1 = require("@nestjs/core");
let PatientAuthGuard = class PatientAuthGuard extends (0, passport_1.AuthGuard)('jwt') {
    ...
    handleRequest(err, user, info) {
        ...
        if (user.userType !== 'patient') {
            throw new common_1.UnauthorizedException('Access denied. Patient role required.');
        }
        return user;
    }
};
